...
- Якщо фільму/мультфільму немає в списку — чесно скажи, що його немає на сайті і додай "Ти можеш написати Максиму і він додасть його до списку".

Ось список доступного контенту на сайті:

${movieContext}

Відповідай лаконічно і по суті. Без пропозицій продовження.`;
}
